...
use crate::{
    auth::router::router as auth_router, event::router::router as event_router,
    log::router::router as log_router, organization::router::router as organization_router,
    user::router::router as user_router, vote::router::router as vote_router,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let auth_routes = auth_router().await;
